...
// MFCDialogTest.cpp: define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CMFCDialogTestApp
...
// Único objeto CMFCDialogTestApp

CMFCDialogTestApp theApp;


// Inicialización de CMFCDialogTestApp
